  ...
  return (
    <Navbar>
      <Navbar.Start>
        ...
        <h2 className="normal-case font-bold ml-2 text-xl">FFXVI Tools</h2>
      </Navbar.Start>
      ...
      <Navbar.End>
        ...
        <Link href="#" title="o/">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="32" viewBox="0 0 48 48">
            <rect width="6" height="32" x="8" y="8" fill="#f44336"></rect><circle cx="30" cy="20" r="12" fill="#f44336"></circle>
          </svg>
        </Link>

        <Link tag="a" target="_blank" href="https://github.com/ConwayCJ/ffxvitools">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="38" viewBox="0 0 30 30">
