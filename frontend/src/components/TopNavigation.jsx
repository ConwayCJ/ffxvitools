import { Navbar, Link, Swap } from "react-daisyui";
...
export default function TopNavigation() {
  ...
  return (
    <Navbar>
      ...
      <Navbar.Start>
        <h2 className="normal-case text-xl ml-4">FFXVI Tools</h2>
      </Navbar.Start>
      ...
      <Navbar.End>
        ...
        <SwapTheme />
        <Link href="#" title="o/">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="32" viewBox="0 0 48 48">
